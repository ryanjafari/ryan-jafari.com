...
export const meta = {
  ...
  description:
    "An obligatory Nitrous.io review that you didn't ask for."
}
...
<Image src={johnsFavorite} alt="Papa John's" />
...
<Image src={wtf} alt='Jackie Chan WTF' />
...
<Image src={pepperoni} alt='Pepperoni pizza' />
