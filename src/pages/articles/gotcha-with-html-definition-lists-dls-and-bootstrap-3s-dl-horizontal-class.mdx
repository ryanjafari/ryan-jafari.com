...
export const meta = {
  date: '2014-04-01',
  title: "Gotcha with HTML Definition Lists (<dl>s) and Bootstrap 3's 'dl-horizontal' Class",
  description:
    'Carlos today gives me a heads-up regarding a gotcha with HTML <dl>s:'
}

export default (props) => <ArticleLayout meta={meta} {...props} />

_Please note that this post will no longer render examples correctly._
