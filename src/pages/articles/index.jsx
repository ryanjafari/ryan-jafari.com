...
export default function ArticlesIndex({ articles }) {
  return (
    <>
      <Head>
        <title>Articles - Ryan Jafari</title>
        <meta
          name="description"
          content="All of my long-form thoughts on programming, products, relationships, management, startups, tinkering, and the future. In the order I had them."
        />
      </Head>
      <SimpleLayout
