...
export const entry = {
  date: '2014-01-30',
  title:
    'How to Include System, Public, And/or Third Party C Libraries in Rubymotion',
  description:
    'This is part one in a series of posts about my trials and tribulations in OS X development with RubyMotion.',
}
...
[2]: https://github.com/kastiglione
[3]: https://github.com/kastiglione/motion.h
