...
- Use ~[KISSmetrics]()~ for A/B testing and figuring out user dropoff areas.
  ...
  - ~[Landing pages & maximum conversions]()~
...
- A cool formula:
  ...
  - X _ Y _ Z = awesome factor (I forgot what they called it)
...
- [Heroku](http://www.heroku.com) and ~[Bluebox]()~ for Rails apps
- Browser support
  - IE 7.0+
  - FF 3.0+
  - Chrome 3.0+
...
- Continuous integration
  ...
  - ~[tddium]()~: integrates smoothly with Heroku
