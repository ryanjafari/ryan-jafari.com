...
import johnsFavorite from './johns_favorite.jpg'
import wtf from './wtf.jpg'
import pepperoni from './pepperoni.jpg'

export const entry = {
  date: '2014-04-17',
  title: '`rbenv` Not Behaving on Nitrous.io Boxes',
  description: "An obligatory Nitrous.io review that you didn't ask for.",
}
...
_But I'm still trucking through it, because I believe in Nitrous.io and what they
hope to achieve. Bringing development environments and their clutter off our
computers and into the cloud._
