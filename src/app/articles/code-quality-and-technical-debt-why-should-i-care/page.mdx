...
import wtfs from './wtfs.png'
import jenga from './jenga.jpg'

export const entry = {
  date: '2014-07-16',
  title: 'Code Quality and Technical Debt... Why Should I Care?',
  description:
...
Ok I understand, but what _exactly_ is this debt? Wikipedia puts it pretty nicely:
...
If you're struggling with an app you feel is burdened by poor code quality and technical debt, check out our ~[Website Watchdog]()~ package that can sniff out your app's silent killers.

~[Learn more about Website Watchdog]()~
